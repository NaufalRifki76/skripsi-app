                    ...
                    <div class="card-body">
                        <form action="">
                            ...
                            <div class="row mb-4">
                                ...
                                <p class="fs-6 text-warning">Lakukan pembayaran dengan transfer ke nomor rekeking yang tersedia
                                    di bawah!</p>
                                <div class="mb-3">
                            ...
                            <div class="row">
                                ...
                                <p class="fs-6 text-warning">Upload bukti transfer anda dengan mengisi formulir di bawah!</p>
                                <div class="mb-3">
                                    <label for="inputState" class="form-label text-white h5">Bukti Transfer <span class="text-danger">*</span></label>
                                    <input type="file" class="form-control bg-white" required accept=".jpg,.jpeg,.png" id=""
                                        placeholder="123456789">
                                </div>
                            </div>
                            <div class="text-center mt-4 mb-3">
                                <button type="submit" class="btn-green-hover text-decoration-none pembayaran">Pesan Lapangan</button>
                            </div>
                        </form>
                    </div>
                </div>
