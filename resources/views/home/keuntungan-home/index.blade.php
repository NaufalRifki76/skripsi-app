...
<div class="mt-5" style="background-color: #ECFAF0">
    <div class="container-fluid text-center">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="400">
            <div class="col-md-4">
                <img src="{{ asset('Assets/home/keuntungan/field.png') }}" class="img-fluid mt-4 mb-4" width="30%"width="30%" alt="mudah">
                <h4 style="color: #439A97">Mudah</h4>
                <p class="fs-6" style="color: #62B6B7">Dapat dengan mudah memesan lapangan yang diinginkan.</p>
            </div>
            <div class="col-md-4">
                <img src="{{ asset('Assets/home/keuntungan/running.png') }}" class="img-fluid mt-4 mb-4" width="30%" alt="cepat">
            ...
            <div class="col-md-4 mb-4">
                <img src="{{ asset('Assets/home/keuntungan/goalkeeper.png') }}" class="img-fluid mt-4 mb-4" width="30%" alt="aman">
