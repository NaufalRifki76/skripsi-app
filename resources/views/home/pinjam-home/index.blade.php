...
<div class="container mt-5 mb-5">
    <div class="row">
        <div class="col-md-5 text-center" style="margin-top: -30px" data-aos="fade-right" data-aos-delay="400">
            <img src="{{ asset('Assets/home/pinjam-alat/pinjam.png') }}" class="img-fluid" width="80%" alt="img-subscribe">
        </div>
        <div class="col-md-7">
