                      ...
                      <div class="text-center mx-5">
                          <form style="width: 100%;">
                              ...
                              <div class="form-floating mb-3">
                                  <input style="border-radius: 5px" type="text" class="form-control" id="floatingInput"
                                      placeholder="name@example.com">
                                  <label for="floatingInput">Nama Lengkap (sesuai di KTP)</label>
                              </div>

                              <div class="form-floating mb-3">
                                  <input style="border-radius: 5px" type="email" class="form-control" id="floatingInput"
                                      placeholder="name@example.com">
                                  <label for="floatingInput">Email</label>
                              </div>

                              <div class="form-floating mb-3">
                                  <input style="border-radius: 5px" type="number" class="form-control" id="floatingInput"
                                      placeholder="name@example.com">
                              ...
                              <div class="form-group row mt-3">
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-floating mb-3 ">
                                          <input style="border-radius: 5px" type="password" class="form-control" id="floatingInput"
                                              placeholder="name@example.com">
                              ...
                              <div>
                                  ...
                                  <div class="d-flex justify-content-center pt-1 mb-2">
                                      <button type="button" class="btn-green-hover">Register</button>
                                  </div>
