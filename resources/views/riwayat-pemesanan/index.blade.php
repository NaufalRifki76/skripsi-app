    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                @else
                    <h5 class="my-5" style="color: #439a97">Harap perlihatkan bukti pemesanan pada pihak penyedia lapangan
                        yang anda pesan!</h5>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-5" style="margin-top: 35px">
                                        <div class="card bg-transparent border-white border-3" style="border-radius: 12px;">
                                            <div class="card-body text-center">
                                                ...
                                                @if ($order->confirmation == 0)
                                                    <p class="fs-6 text-white" style="margin-bottom: -5px"> Menunggu di
                                                        setujui oleh pihak lapangan!</p>
                                                @elseif ($order->confirmation == 1)
                                                    <p class="fs-6" style="margin-bottom: -5px"> Pesanan anda berhasil!
                                                    </p>
                                                @elseif ($order->confirmation == 2)
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" disabled class="form-control bg-white" id=""
                                            value="{{ $order->cust_number }}" placeholder="">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="inputState" class="form-label text-white h5">Email Pemesan</label>
                                        <input type="text" disabled class="form-control bg-white" id=""
                                            value="{{ $order->cust_email }}" placeholder="">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="inputState" class="form-label text-white h5">Lapangan</label>
                                        <input type="text" disabled class="form-control bg-white" id=""
                                            value="{{ $order->field }}" placeholder="">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="inputState" class="form-label text-white h5">Tanggal Pemesanan
                                            Lapangan</label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" disabled class="form-control bg-white" id=""
                                            value="Rp. {{ $order->price_sum }}" placeholder="">
                                    </div>
                                    @if ($order->confirmation == 2)
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control border-2" style="background-color: #fff" id="cancel_reason" name="cancel_reason"
                                                rows="3" placeholder="">{{ $order->cancel_reason }}</textarea>
                                        </div>
                                    @endif
                                </div>
                            </div>
