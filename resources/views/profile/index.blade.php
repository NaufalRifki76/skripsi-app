                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input class="form-control form-control-lg shadow bg-white" type="email" class="form-control"
                                    id="nama" aria-describedby="nama" disabled style="border: none;" value="">
                            </div>
                            <div class="mb-5">
                                <label for="telepon" class="form-label h5">No. Telepon</label>
                                <input class="form-control form-control-lg shadow bg-white" type="email" class="form-control"
                                    id="telepon" aria-describedby="telepon" disabled style="border: none;" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input class="form-control form-control-lg shadow bg-white" type="email" class="form-control"
                                    id="email" aria-describedby="email" disabled style="border: none;" value="">
                            </div>
                            <div class="mb-5">
                                <label for="jenis-akun" class="form-label h5">Jenis Akun</label>
                                <input class="form-control form-control-lg shadow bg-white" type="email" class="form-control"
                                    id="jenis-akun" aria-describedby="jenis-akun" disabled style="border: none;" value="">
                            </div>
                        </div>
                    </div>
                </div>
